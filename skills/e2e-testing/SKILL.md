---
name: e2e-testing
description: Playwright E2E testing patterns — Page Object Model, test structure, configuration, flaky test strategies, artifact management, and CI/CD integration.
---

# E2E Testing Patterns

Comprehensive Playwright patterns for building stable, fast, and maintainable E2E test suites. This skill is the pattern library for the `e2e-runner` agent.
...
### Traces
Configured in `playwright.config.ts` via `trace: 'on-first-retry'`. View with:
```bash
